    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className={`space-y-8 text-center text-gray-900 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-lg leading-relaxed">
            Providing access to over 50 million live event listings, we give you the freedom to buy or sell from any device, in nearly every currency and language – any time. The freedom to experience your love of live IRL. To dance 'til you drop. To sing at the top of your lungs. The freedom to laugh until you cry. To scream yourself hoarse at that championship-winning goal. To be surrounded by your fellow fans, having the time of your life.
          </p>
